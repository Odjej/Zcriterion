...
#for i in range(0, len(Temp[0])):
 #   for j in range(0, len(Temp[0])):
        # E-field behöver dessa funktioner, kolla om vi ska ha samma argument eller inte
...
#ds.collisions.bremsstrahlung_mode = Collisions.BREMSSTRAHLUNG_MODE_STOPPING_POWER #### #undersök utan
